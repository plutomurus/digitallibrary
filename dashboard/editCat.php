            ...
            <form class="form-label-left input_mask" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" placeholder="Kategori Baru" name="kategori" value="<?= $row["NamaKategori"] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-9 col-sm-9  offset-md-3">
                        <a class="btn btn-primary" href="?page=kategori">Cancel</a>
